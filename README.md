...
3. Go to the `Configuration` tab on the addon and input the file name of your .OVPN file. Also *optionally* add your username and password to connect to your OpenVPN server.
